        ...
        <div class="mx-auto max-w-2xl">
            ...
            <div class="relative bg-white">
                ...
                <div class="px-6 lg:contents">
                    <div
                        class="mx-auto max-w-2xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:max-w-full lg:flex-none lg:pt-32">
                        <p class="text-base font-semibold leading-7 text-indigo-600">Infrastructure</p>
                        <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Indonesia's
                            Education System Undergoes Major Reforms</h1>
                        <p class="mt-6 text-xl leading-8 text-gray-700">Jakarta, Indonesia - In a groundbreaking
                            move to elevate the nation's educational landscape, the Indonesian government has
                            unveiled a comprehensive set of reforms aimed at creating a more equitable, innovative,
                            and globally competitive education system.

                            At the heart of these reforms lies the "Merdeka Belajar" (Independent Learning)
                            initiative, which empowers schools to tailor their curriculum to meet the unique needs
                            of their students. By fostering creativity and critical thinking, this approach seeks to
                            equip Indonesian youth with the skills necessary to thrive in the 21st century.

                            In addition to curriculum flexibility, the government is investing heavily in teacher
                            professional development, ensuring that educators are equipped with the latest
                            pedagogical techniques and content knowledge. This emphasis on teacher quality is a
                            cornerstone of the reforms, recognizing that effective instruction is paramount to
                            student success.

                            To bridge the digital divide and enhance access to education, the government is also
                            promoting the integration of technology into the classroom. From online learning
                            platforms to digital textbooks, these initiatives aim to create a more inclusive and
                            engaging learning environment.

                            The reforms also address the skills gap in the Indonesian economy by expanding
                            vocational training programs. By preparing students for the workforce, these initiatives
                            seek to create a more productive and competitive labor market.

                            As the reforms unfold, it remains to be seen whether they will achieve their ambitious
                            goals and help Indonesia to establish itself as a global education leader. However, the
                            government's commitment to educational innovation and equity is a promising sign for the
                            nation's future.</p>
                    </div>
                </div>
            </div>
