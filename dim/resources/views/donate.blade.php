...
<div class="bg-gray-50">
    <div class="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
            <div>
                <div>
                    <h2 class="text-lg font-medium text-gray-900 pt-10">Contact information</h2>
                ...
                <div class="mt-10 border-t border-gray-200 pt-10">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <select id="country-code" name="country-code" autocomplete="country-code"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        ...
                        <div class="sm:col-span-2">
                            <label for="apartment" class="block text-sm font-medium text-gray-700">Donation amount</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-2">
                            <label for="apartment" class="block text-sm font-medium text-gray-700">Comment</label>
                            <div class="mt-1">
                                <input type="text" name="apartment" id="apartment"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                            </div>
            ...
            <div class="mt-10 lg:mt-0">
                <h2 class="text-lg font-medium text-gray-900">Donation summary</h2>
                ...
                <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                        <button type="submit"
                            class="w-full rounded-md border border-transparent bg-blue-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-50">Confirm
                            order</button>
                    </div>
                </div>
            </div>
